...
We would like to be **confident** ($\delta$) that the difference between the expectation and the estimate (i.e. $\vert\overline{X}_n-p\vert$) is within some **error** ($\epsilon$):
