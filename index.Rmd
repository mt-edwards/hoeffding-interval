...
An estimate $\hat\theta_n$ of a parameter $\theta$ has a $(1-\delta)$% confidence interval $\hat\theta_n\pm\epsilon$ if with at least $1-\delta$ probability the statement
...
If you construct a confidence interval and $\epsilon$ is large for a given test set size you know that your estimate is uncertain and should you increase your test set size.
